...
const education = [
  {
    ...
    detail: '<strong>Университет ИТМО · магистратура</strong><br>27.04.04, вечерний формат, 2026–2028',
  },
  {
  ...
  },
  {
    ...
    detail: 'Победитель школы ИТМО; призёр RoboSchool по 5 трекам, 2026',
  },
];
...
const experience = [
  ...
  {
    title: 'Клиентское сопровождение',
    meta: 'Июнь 2025 — июль 2026',
    text: 'Документы, страховые полисы и обращения: уточнение вводных, проверка комплектности, деловая переписка и контроль сроков.',
  },
];
...
const variants = [
  {
    ...
    summary: 'Мне близки задачи, где нужно поговорить с участниками процесса, увидеть ручную рутину и исключения, а затем превратить их в понятный цифровой контур. Продумываю пользовательские сценарии до мелочей, задаю критерии результата и использую Python, API и AI‑инструменты, чтобы собрать, проверить и передать решение пользователям.',
    ...
    projects: [
      ...
      {
        title: 'Автоматизация подготовки 3‑НДФЛ',
    ...
    note: 'Целевые вакансии: разработка внутренних инструментов, автоматизация бизнес‑процессов, техническое внедрение AI и начальные задачи системного анализа.',
  },
];
